...
//		controller->theta_elec = encoder->ElecPosition;
//		controller->dtheta_elec = encoder->ElecVelocity;
//		controller->dtheta_mech = encoder->MechVelocity;
//		controller->theta_mech = encoder->MechPosition;
//
//       /// Commutation  ///
